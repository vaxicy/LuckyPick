export const I18N = {
    zh: {
      ...
      onboard_skip: '跳过',
      onboard_start: '开始使用',
      theme_on_toast: '🌙 深色模式已开启',
      theme_off_toast: '☀️ 深色模式已关闭',
      sound_on_toast: '🔊 音效已开启',
      sound_off_toast: '🔇 音效已关闭',
      time_now: '刚刚',
      time_min_ago: '{0} 分钟前',
      click_load: '点击加载',
      delete_action: '删除',
    ...
    en: {
      ...
      theme_on_toast: '🌙 Dark mode ON',
      theme_off_toast: '☀️ Dark mode OFF',
      sound_on_toast: '🔊 Sound ON',
      sound_off_toast: '🔇 Sound OFF',
      time_now: 'Just now',
    ...
    es: {
      ...
      roll_btn_coin: '🪙 Lanza la moneda',
      roll_btn_wheel: '🎡 Gira la ruleta',
      roll_btn_slot: '🎉 Sortear',
      roll_btn_rps: '✊ Piedra, papel o tijera',
      battle_title_dice: 'Lanzando...',
      battle_title_coin: 'Lanzando moneda...',
      battle_title_wheel: 'Girando...',
      battle_title_slot: 'Sorteando...',
      battle_title_rps: 'Piedra, papel o tijera...',
      winner_label: 'Resultado',
      again: 'Otra vez',
      export_btn: '🖼 Exportar',
      history_title: '📋 Historial',
      history_empty: 'Sin registros',
      history_empty_hint: 'Pulsa "Otra vez" para empezar',
      history_incognito: 'Modo incógnito: no se guarda el historial',
      clear_history: 'Borrar historial',
      exported: 'Imagen exportada',
      min_options: 'Se necesitan al menos 2 opciones',
      max_options: 'Máximo 6 opciones',
      coin_hint: 'El modo moneda usa las primeras 2 opciones',
      tie_title: 'Empate',
      tie_msg: 'Otra ronda para desempatar',
      result_msgs_dice: ['Lucky Pick'],
      result_msgs_coin: ['Lucky Pick'],
      result_msgs_wheel: ['Lucky Pick'],
      result_msgs_rps: ['Lucky Pick'],
      add_option: '+ Añadir opción',
      opt_placeholder_a: 'Opción A...',
      opt_placeholder_b: 'Opción B...',
      opt_placeholder: 'Opción {0}...',
      settings_title: '⚙ Ajustes',
      settings_tip: 'Ajustes',
      settings_game: '🎮 Juego',
      settings_preference: '⚙ Preferencias',
      history_tip: 'Historial',
      language: 'Idioma',
      theme_label: 'Modo oscuro',
      incognito_label: 'Incógnito',
      sound_label: 'Sonido',
      animation_speed: 'Animación',
      speed_normal: 'Normal',
      speed_fast: 'Rápida',
      speed_slow: 'Lenta',
      ...
      load_history: '¿Cargar este registro?',
      rule_export_high: 'Gana el mayor',
      favorites_tip: 'Favoritos',
      favorites_title: 'Favoritos',
      save_favorite: '⭐ Guardar opciones actuales',
      save_favorite_name: 'Nombre del favorito',
      favorites_empty: 'Sin favoritos',
      load_favorite: '¿Cargar este favorito?',
      delete_favorite: '¿Eliminar este favorito?',
      donate_text: 'Si te resulta útil, ¡invítame a un café!',
      donate_wechat_btn: 'WeChat',
      donate_paypal_btn: 'PayPal',
      copy_btn: '📋 Copiar',
      copy_tpl: '🎲 Lucky Pick decidió: {0}\n(entre {1})',
      copied: 'Copiado al portapapeles',
      copy_failed: 'Error al copiar, selecciona manualmente',
      bulk_btn: '📋 Importar',
      bulk_placeholder: 'Uno por línea, o separado por comas',
      bulk_confirm: 'Importar',
      bulk_added: '{0} opciones importadas',
      bulk_truncated: '{0} importadas (máx {1})',
      again_exclude: '🔄 Otro',
      need_two_options: 'Se necesitan al menos 2 opciones',
      search_history: 'Buscar en el historial...',
      search_favorites: 'Buscar en favoritos...',
      no_match: 'Sin coincidencias',
      undo: 'Deshacer',
      history_deleted: '1 registro eliminado',
      fav_deleted: 'Favorito eliminado',
      history_cleared: 'Historial borrado',
      weight_tip: 'Duplica la probabilidad de esta opción (x2)',
      again_exclude_title: 'Quita "{0}" y repite entre el resto',
      all_weighted: 'Ponderar todo se anula',
      fav_saved: 'Guardado en favoritos',
      fav_updated: 'Favorito actualizado',
      rename_favorite: 'Renombrar favorito',
      favorites_empty_hint: "ej. Almuerzo → McDonald's / KFC / Pizza",
      onboard_title_1: 'Bienvenido a Lucky Pick 👋',
      onboard_text_1: 'Escribe 2-10 opciones, pulsa el botón y deja que la suerte decida.',
      onboard_title_2: '🎮 Cinco modos',
      onboard_text_2: 'Toca ⚙️ para cambiar Dado / Moneda / Ruleta / Sorteo / PPT, y activa el sonido y el modo oscuro.',
      onboard_title_3: '📋 Historial y favoritos',
      onboard_text_3: '📋 guarda tus últimos 50 resultados, ⭐ guarda conjuntos de opciones para recargarlos al instante.',
      onboard_next: 'Siguiente',
      onboard_skip: 'Saltar',
      onboard_start: 'Empezar',
      theme_on_toast: '🌙 Modo oscuro activado',
      theme_off_toast: '☀️ Modo oscuro desactivado',
      sound_on_toast: '🔊 Sonido activado',
      sound_off_toast: '🔇 Sonido desactivado',
      time_now: 'Ahora mismo',
      time_min_ago: 'hace {0} min',
      click_load: 'Pulsa para cargar',
...
export function setLang(next) {
  if (next === 'zh' || next === 'en' || next === 'es') moduleLang = next;
}
